...
export default function AdminLoginPage() {
  ...
  function handleLogin(e: React.FormEvent) {
    ...
    // Case-insensitive on purpose: an earlier exact-case match against the
    // documented password silently rejected valid logins.
    setTimeout(() => {
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <button type="submit" disabled={loading} className="s5 a-btn" style={{ marginTop: 4 }}>
